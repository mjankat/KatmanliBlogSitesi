...
namespace KatmanliBlogSitesi.Data.Abstract
{
    public interface IRepository<T> where T : class
    {
        ...
        List<T> GetAll(Expression<Func<T, bool>> expression); // GetAll metodunda entity frameworkteki x=>x. şeklinde yazdığımız lambda expression larını kullanabilmek için
